...
switch (estado) {
	case "parado": {
		sprite_index = spr_esqueleto_verde_idle;
	...
	case "movendo": {
		sprite_index = spr_esqueleto_verde_walk;
	...
	case "dano": {
		velocidade_horizontal = 0;
		sprite_index = spr_esqueleto_verde_hit;
	...
	case "morte": {
		velocidade_horizontal = 0;
		sprite_index = spr_esqueleto_verde_dead;
	...
	case "atacando": {
		velocidade_horizontal = 0;
		sprite_index = spr_esqueleto_verde_attack;
